...
@section('content')
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">CHỈNH SỬA SIZE</h1>
        </div>
        <!-- PAGE-HEADER END -->
            ...
            <div class="col-xl-14">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Chỉnh sửa size</h3>
                    </div>
                    <form method="post" action="{{ route('Size.update',['Size'=>$edit]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            <div class="form-group">
                                <label  for="exampleInputname1">Tên màu</label>
                                <input type="string" class="form-control" id="exampleInputname1" placeholder="Tên size" name="name" value="{{ $edit->TenSize }}">
                            </div>
                        ...
                        <div class="card-footer text-end">
                            ...
                            <a href="{{ route('Size.index') }}" class="btn btn-danger my-1">Quay lại</a>
                        </div>
                    </form>
                </div>
            </div>
