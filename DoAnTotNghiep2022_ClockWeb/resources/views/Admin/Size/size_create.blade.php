...
@section('content')
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">THÊM SIZE</h1>
        </div>
        <!-- PAGE-HEADER END -->
                    ...
                    <form method="post" action="{{ route('Size.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label  for="exampleInputname1">Tên size</label>
                                <input type="string" class="form-control" id="exampleInputname1" placeholder="Tên size" name="name" >
                            </div>
                        </div>
