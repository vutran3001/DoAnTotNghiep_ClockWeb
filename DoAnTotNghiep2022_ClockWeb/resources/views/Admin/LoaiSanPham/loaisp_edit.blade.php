...
@section('content')
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">CHỈNH SỬA LOẠI SẢN PHẨM</h1>
        </div>
        <!-- PAGE-HEADER END -->
        ...
        <div class="row">
            <div class="col-xl-14">
                <div class="card">
                    ...
                    <form method="post" action="{{ route('LoaiSanPham.update',['LoaiSanPham'=>$edit]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            <div class="form-group">
                                <label  for="exampleInputname1">Tên loại sản phẩm</label>
                                <input type="string" class="form-control" id="exampleInputname1" placeholder="Tên loại sản phẩm" name="name" value="{{ $edit->TenLoaiSanPham }}">
                            </div>
                        ...
                        <div class="card-footer text-end">
                            ...
                            <a href="{{ route('LoaiSanPham.index') }}" class="btn btn-danger my-1">Quay lại</a>
                        </div>
                    </form>
                </div>
            </div>
