     ...
     <div class="main-container container-fluid">
        ...
        <div class="row row-sm">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('Mau.create') }}" class="btn btn-primary">Thêm màu</a>
                        <h1></h1>
                            ...
                            <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-15p border-bottom-0">Tên màu</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('Mau.edit',['Mau'=>$mau->id]) }}"><button type="button" class="btn btn-icon  btn-success"><i class="fe fe-edit"></i></button></a>
                                            <a type="button">
                                                <form method="post" action="{{ route('Mau.destroy',['Mau'=>$mau->id]) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('DELETE')
